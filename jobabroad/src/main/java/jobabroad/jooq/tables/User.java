...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = -891226077;

    /**
     * The reference instance of <code>jobabroad.user</code>
     */
    ...
    /**
     * The column <code>jobabroad.user.id</code>.
     */
    ...
    /**
     * The column <code>jobabroad.user.username</code>.
     */
    ...
    /**
     * The column <code>jobabroad.user.password</code>.
     */
    ...
    /**
     * The column <code>jobabroad.user.permission</code>.
     */
    public final TableField<UserRecord, String> PERMISSION = createField("permission", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");

    /**
     * Create a <code>jobabroad.user</code> table reference
     */
    public User() {
    ...
    /**
     * Create an aliased <code>jobabroad.user</code> table reference
     */
